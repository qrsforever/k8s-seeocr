...
# c.NotebookApp.allow_origin = '*.erlangai.cn'
...
#  they are limited.
c.NotebookApp.iopub_data_rate_limit = 3000000
...
c.NotebookApp.rate_limit_window = 6
...
c.NotebookApp.tornado_settings = {
    'headers': {
        ...
        'Content-Security-Policy': "frame-ancestors 'self' *.erlangai.cn",
    }
}
